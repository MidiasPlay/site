...
type PlanosContainerProps = {
    //
};

const PlanosComodato: React.FC<PlanosContainerProps> = ({}) => {
    return (
        <>
                    ...
                    <div className="plan-card">
                        ...
                        <div className="plan-features">
                            ...
                            <ul>
                                ...
                                <li><i className="fas fa-check"></i> TV Box incluso*</li>
            ...
            <div className="container">
                <div className="tvbox-content">
                    ...
                    <div className="tvbox-info">
                        <h2>TV Box Incluso em Todos os Planos*</h2>
                        <p>Receba o dispositivo completo para conectar em qualquer TV e começar a usar imediatamente.</p>
                        ...
                        <p className="tvbox-note">*Equipamento em comodato durante a vigência do contrato</p>
                    </div>
                </div>
            </div>
        </section>
