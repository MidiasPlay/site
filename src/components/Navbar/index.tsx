        ...
        <nav className={`navbar ${isScrolled ? 'scrolled' : ''} ${className}`}>
            <div className="nav-container">
                ...
                <ul className="nav-menu">
                    {navItems.map((item) => (
                        <li key={item.label} className={`nav-item ${item.childrenList ? 'dropdown' : ''}`}>
                            {item.childrenList ? (
                                <>
                                    ...
                                    <DropdownMenu children={item.childrenList} />
                                </>
                            ) : (
            ...
            <div className={`mobile-menu ${isMobileMenuOpen ? 'active' : ''}`}>
                <ul className="mobile-nav-list">
                    {navItems.map((item) => (
                        <li key={item.label} className={item.childrenList ? 'mobile-dropdown' : ''}>
                            {item.childrenList ? (
                                <>
